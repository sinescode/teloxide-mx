<div align="center">
  <img src="https://github.com/sinescode/teloxide_max/blob/main/media/teloxide-max-logo.jpg?raw=true" width="250"/>
  <h1><code>teloxide_max</code></h1>
  <a href="https://docs.rs/teloxide_max/">
    <img src="https://docs.rs/teloxide_max/badge.svg">
  </a>
  <a href="https://github.com/sinescode/teloxide_max/actions">
    <img src="https://github.com/sinescode/teloxide_max/workflows/Continuous%20integration/badge.svg">
  </a>
  <a href="https://crates.io/crates/teloxide_max">
    <img src="https://img.shields.io/crates/v/teloxide_max.svg">
  </a>
  <a href="https://core.telegram.org/bots/api">
    <img src="https://img.shields.io/badge/API%20coverage-Up%20to%2010.2%20(inclusively)-green.svg">
  </a>
  <a href="https://t.me/teloxide_max">
    <img src="https://img.shields.io/badge/support-t.me%2Fteloxide_max-blueviolet">
  </a>
  <a href="https://devpod.sh/open#https://github.com/sinescode/teloxide_max">
...
## Highlights
 ...
 - **Declarative design.** `teloxide_max` is based upon [`dptree`], a functional [chain of responsibility] pattern that allows you to express pipelines of message processing in a highly declarative and extensible style.

[`dptree`]: https://github.com/teloxide_max/dptree
...
[Sqlite]: https://www.sqlite.org
 ...
 - **Strongly typed commands.** Define bot commands as an `enum` and `teloxide_max` will parse them automatically — just like JSON structures in [`serde-json`] and command-line arguments in [`structopt`].
...
```
 ...
 4. Make sure that your Rust compiler is up to date (`teloxide_max` currently requires rustc at least version 1.85):
```bash
...
```toml
[dependencies]
teloxide_max = { version = "0.17.0", features = ["macros"] }
log = "0.4"
...
```toml
teloxide_max = { git = "https://github.com/sinescode/teloxide_max.git", features = ["macros"] }
```
...
[[`examples/throw_dice.rs`](crates/teloxide_max/examples/throw_dice.rs)]
...
async fn main() {
    ...
    teloxide_max::repl(bot, |bot: Bot, msg: Message| async move {
...
<div align="center">
    <img src="https://github.com/sinescode/teloxide_max/blob/master/media/throw-dice.gif?raw=true" width="420" />
</div>
...
[[`examples/command.rs`](crates/teloxide_max/examples/command.rs)]

```rust,no_run
use teloxide_max::{prelude::*, utils::command::BotCommands};
...
<div align="center">
    <img src="https://github.com/sinescode/teloxide_max/blob/master/media/command.gif?raw=true" width="420" />
</div>
...
[[`examples/dialogue.rs`](crates/teloxide_max/examples/dialogue.rs)]
...
<div align="center">
    <img src="https://github.com/sinescode/teloxide_max/blob/master/media/dialogue.gif?raw=true" width="420" />
</div>

[More examples >>](crates/teloxide_max/examples/)

## Testing

The community has made a crate called [`teloxide_max_tests`](https://github.com/LasterAlex/teloxide_max_tests) for testing `teloxide_max` bots.

[See some testing examples >>](https://github.com/LasterAlex/teloxide_max_tests/tree/master/examples)

## Tutorials

 - [_`dptree` starter guide with teloxide_max_](https://github.com/sinescode/teloxide_max/blob/master/DPTREE_GUIDE.md)
 - [_"Migrating my family finance bot from Python to Rust (teloxide_max) because I am tired of exceptions (part 1)"_](https://web.archive.org/web/20230130112018/https://trkohler.com/posts/i-migrated-my-family-finance-bot-from-python-to-rust-because-i-am-tired-of-exceptions/) by Troy Köhler.
 - [_"Migrating my family finance bot from Python to Rust (teloxide_max) [part 2]"_](https://web.archive.org/web/20240529200929/https://trkohler.com/posts/migrating-my-family-finance-bot-from-python-to-rust-teloxide_max-part-2/) by Troy Köhler.
...
[Issues]: https://github.com/sinescode/teloxide_max/issues
[our official Telegram group]: https://t.me/teloxide_max
[GitHub Discussions]: https://github.com/sinescode/teloxide_max/discussions
...
A: You can! `teloxide_max` has a built-in support for webhooks in `dispatching::update_listeners::webhooks` module. See how it's used in [`examples/ngrok_ping_pong_bot.rs`](crates/teloxide_max/examples/ngrok_ping_pong.rs) and [`examples/heroku_ping_pong_bot.rs`](crates/teloxide_max/examples/heroku_ping_pong.rs).

**Q: Can I handle both callback queries and messages within a single dialogue?**

A: Yes, see [`examples/purchase.rs`](crates/teloxide_max/examples/purchase.rs).
...
A: Check out [@TheAwiteb]'s [WebApp `teloxide_max` example].

[@TheAwiteb]: https://github.com/TheAwiteb
[WebApp `teloxide_max` example]: https://gist.github.com/TheAwiteb/8d809b34b619b01e64453bb31dbd8bf4
...
See [2500+ other public repositories using `teloxide_max` >>](https://github.com/sinescode/teloxide_max/network/dependents)
