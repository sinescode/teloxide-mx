...
async fn test_postgres_json() {
    let storage = PostgresStorage::open(
        "postgres://teloxide_max:rewrite_it_in_rust@localhost:5432/test_postgres_json",
        1,
...
async fn test_postgres_bincode() {
    let storage = PostgresStorage::open(
        "postgres://teloxide_max:rewrite_it_in_rust@localhost:5432/test_postgres_bincode",
        1,
...
async fn test_postgres_cbor() {
    let storage = PostgresStorage::open(
        "postgres://teloxide_max:rewrite_it_in_rust@localhost:5432/test_postgres_cbor",
        1,
