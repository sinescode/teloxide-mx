...
| `macros`             | Re-exports macros from [`teloxide_max_macros`]. |
...
| `nightly`            | Enables nightly-only features (see the [`teloxide_max_core` features]). |
...
[`teloxide_max_macros`]: https://github.com/sinescode/teloxide_max_max_macros
[`native-tls`]: https://docs.rs/native-tls
[`rustls`]: https://docs.rs/rustls
[`teloxide_max_core` features]: https://docs.rs/teloxide_max_core/latest/teloxide_max_core/#cargo-features
