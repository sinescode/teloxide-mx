...
//!
//! [`payloads`]: teloxide_max_core::payloads

use teloxide_max_core::{payloads::*, types::*};
...
mod tests {
    ...
    use super::*;
    use teloxide_max_core::{prelude::*, Bot};
    ...
    fn test_reply_to_adaptors() {
        use teloxide_max_core::{adaptors::trace::Settings, requests::HasPayload};
