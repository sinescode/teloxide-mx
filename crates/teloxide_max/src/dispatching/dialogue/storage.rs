...
use teloxide_max_core::types::{ChatId, ThreadId, UserId};
...
#[cfg(feature = "mongodb-storage")]
pub use mongodb_storage::{MongoStorage, MongoStorageError};
...
/// - [`MongoStorage`] -- a MongoDB-based persistent storage.
///
...
/// [`MongoStorage`]: crate::dispatching::dialogue::MongoStorage
pub trait Storage<D> {
    type Error;
