...
//!
//! ```
//! use teloxide_max::utils::command::parse_command;
//!
...
//!
//! ```
//! use teloxide_max::utils::command::parse_command_with_prefix;
//!
...
//!
//! [examples/admin]: https://github.com/sinescode/teloxide_max/blob/master/crates/teloxide_max/examples/admin.rs
...
use teloxide_max_core::types::{BotCommand, Me};
#[cfg(feature = "macros")]
pub use teloxide_max_macros::BotCommands;
...
/// ```
/// # #[cfg(feature = "macros")] {
/// use teloxide_max::utils::command::{BotCommands, ParseError};
///
...
impl<'a> CommandDescriptions<'a> {
    ...
    ///
    /// ```
    /// use teloxide_max::utils::command::{CommandDescription, CommandDescriptions};
    ///
