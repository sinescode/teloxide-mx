...
//! supported.
//!
//! For a high-level overview, see [our GitHub repository](https://github.com/sinescode/teloxide_max).
//!
//! [[`examples/throw_dice.rs`](https://github.com/sinescode/teloxide_max/blob/master/crates/teloxide_max/examples/throw_dice.rs)]
//! ```no_run
...
//! <div align="center">
//!   <kbd>
//!     <img src=https://github.com/sinescode/teloxide_max/raw/master/media/throw-dice.gif width=420px />
//!   </kbd>
//! </div>
//!
...
//! handler function):
//! ```no_run
//! use teloxide_max::{prelude::*, types::User};
//!
...
//! [_this guide_]: https://github.com/sinescode/teloxide_max/blob/master/DPTREE_GUIDE.md
...
// https://github.com/sinescode/teloxide_max/blob/main/media/teloxide_max-logo.jpg
#![doc(
    html_logo_url = "https://github.com/sinescode/teloxide_max/raw/main/media/teloxide_max-logo.jpg",
    html_favicon_url = "https://github.com/sinescode/teloxide_max/raw/main/media/teloxide_max-logo.jpg"
)]
...
#[cfg(feature = "macros")]
pub use teloxide_max_macros as macros;
...
use teloxide_max_core::requests::ResponseResult;
