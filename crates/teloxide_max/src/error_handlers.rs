...
//! # use teloxide_max::error_handlers::*;
//! # use teloxide_max::error_types::TelegramError;
//!
//! // Log errors
...
/// ## Examples
/// ```
/// use teloxide_max::error_handlers::OnError;
///
/// # #[tokio::main]
/// # async fn main_() {
/// // Prints nothing
...
/// ```
/// use teloxide_max::error_handlers::{IgnoringErrorHandler, OnError};
///
/// # #[tokio::main]
/// # async fn main_() {
/// let err: Result<i32, i32> = Err(404);
...
/// # #[tokio::main]
/// # async fn main_() {
/// use teloxide_max::error_handlers::{ErrorHandler, IgnoringErrorHandler};
///
...
///
/// use teloxide_max::error_handlers::{ErrorHandler, IgnoringErrorHandlerSafe};
///
...
///
/// ```compile_fail
/// use teloxide_max::dispatching::{ErrorHandler, IgnoringErrorHandlerSafe};
///
...
/// # #[tokio::main]
/// # async fn main_() {
/// use teloxide_max::error_handlers::{ErrorHandler, LoggingErrorHandler};
///
