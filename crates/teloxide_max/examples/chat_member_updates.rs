use teloxide_max::{prelude::*, types::ParseMode, utils::html};
use teloxide_max_core::adaptors::DefaultParseMode;
...
///
/// [requester adaptor]: teloxide_max::requests::Requester#adaptors
type Bot = DefaultParseMode<teloxide_max::Bot>;
...
async fn main() -> ResponseResult<()> {
    ...
    // `html::user_mention`
    let bot = teloxide_max::Bot::from_env().parse_mode(ParseMode::Html);
