...
impl_payload! {
    ...
    pub SendPoll (SendPollSetters) => Message {
        ...
        optional {
            /// Media to attach to the poll. TBA 10.0+
            pub media: InputPollMedia,
            /// Media to display as the quiz explanation. TBA 10.0+
            pub explanation_media: InputPollMedia,
            /// Restricts the poll to chat members. TBA 10.0+
            ...
            /// Pass true if the poll allows changing chosen answer options (revoting). TBA 10.0+
            pub allows_revoting: bool,
            /// Pass true if the poll options must be shown in random order. TBA 10.0+
            pub shuffle_options: bool,
            /// Pass true if answer options can be added to the poll after creation. TBA 10.0+
            pub allow_adding_options: bool,
            /// Pass true if poll results must be shown only after the poll closes. TBA 10.0+
            pub hide_results_until_closes: bool,
            /// 0-based identifier of the correct answer option, required for polls in quiz mode
            pub correct_option_id: u8,
            /// A JSON-serialized list of monotonically increasing 0-based identifiers of the correct answer options. TBA 10.0+
            pub correct_option_ids: Vec<u8> [collect],
            /// Description of the poll to be sent, 0-1024 characters after entities parsing. TBA 10.0+
            pub description: String [into],
            /// Mode for parsing entities in the poll description. TBA 10.0+
            pub description_parse_mode: ParseMode,
            /// List of special entities that appear in the poll description. TBA 10.0+
