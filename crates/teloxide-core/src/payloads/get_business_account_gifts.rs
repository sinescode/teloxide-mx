...
impl_payload! {
    ...
    pub GetBusinessAccountGifts (GetBusinessAccountGiftsSetters) => OwnedGifts {
        ...
        optional {
            ...
            /// Pass true to exclude limited upgradable gifts. TBA 9.3+
            pub exclude_limited_upgradable: bool,
            /// Pass true to exclude limited non-upgradable gifts. TBA 9.3+
            pub exclude_limited_non_upgradable: bool,
            /// Pass true to exclude blockchain gifts. TBA 9.3+
