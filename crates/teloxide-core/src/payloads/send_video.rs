...
impl_payload! {
    ...
    pub SendVideo (SendVideoSetters) => Message {
        ...
        optional {
            /// For outgoing ephemeral messages, unique identifier of the user who will receive the message. TBA 10.2+
            pub receiver_user_id: UserId,
            /// For outgoing ephemeral messages, identifier of the callback query. TBA 10.2+
