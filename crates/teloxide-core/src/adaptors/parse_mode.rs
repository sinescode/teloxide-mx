...
use crate::{
    payloads::{
        ...
        EditEphemeralMessageText, EditMessageCaption, EditMessageCaptionInline,
        EditMessageChecklist, EditMessageMedia, EditMessageMediaInline, EditMessageText,
...
where
    ...
    B::SendChatJoinRequestWebApp: Clone,
    B::SendRichMessageDraft: Clone,
    B::SendRichMessage: Clone,
...
fn visit_parse_modes_in_inline_query_result(
    ...
    mut visitor: impl FnMut(&mut Option<ParseMode>),
) {
