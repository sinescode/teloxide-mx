...
pub struct ChatFullInfo {
    ...
    /// User rating based on Star spendings. TBA 9.3+
    pub rating: Option<crate::types::UserRating>,

    /// Number of stars paid for messages. TBA 9.3+
    pub paid_message_star_count: Option<u32>,

    /// Colors from unique gifts. TBA 9.3+
    pub unique_gift_colors: Option<crate::types::UniqueGiftColors>,

    /// User's first profile audio. TBA 9.4+
    pub first_profile_audio: Option<crate::types::Audio>,

    /// The community the chat belongs to, if any. TBA 10.2+
