...
pub enum RequestError {
    ...
    ///
    /// [open an issue]: https://github.com/sinescode/teloxide_max/issues/new
...
impl_api_error! {
    ...
    pub enum ApiError {
        ...
        /// Error which is not known to `teloxide_max`.
        ///
        /// If you've received this error, please [open an issue] with the
        /// description of the error.
        ///
...
///
/// ```rust
/// # use teloxide_max_core::errors::{DownloadError, RequestError};
///
