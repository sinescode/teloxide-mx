...
///
/// ```compile_fail
/// # use teloxide_max_core::{prelude::*, types::{ChatId, ParseMode}};
/// let bot: Bot = Bot::new("TOKEN").parse_mode(ParseMode::Html);
/// ```
/// ```rust
/// # use teloxide_max_core::{prelude::*, types::{ChatId, ParseMode}, adaptors::DefaultParseMode};
...
/// # use teloxide_max_core::{adaptors::{DefaultParseMode, Throttle}, requests::RequesterExt, types::ParseMode};
/// type Bot = DefaultParseMode<Throttle<teloxide_max_core::Bot>>;
///
/// let bot: Bot = teloxide_max_core::Bot::new("TOKEN")
///     .throttle(<_>::default())
///     .parse_mode(ParseMode::Html);
/// # let _ = bot;
/// # };
...
///
/// ```toml
/// teloxide_max_core = { version = "...", features = ["throttle"] }
/// ```
///
