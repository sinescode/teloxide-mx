...
pub use input_file::*;
pub use input_media::*;
pub use input_media_live_photo::*;
...
pub use input_rich_message_content::*;
...
mod input_rich_message_content;
mod input_sticker;
...
// Issue https://github.com/sinescode/teloxide_max/issues/1135
