...
pub enum MessageKind {
    ...
    ManagedBotUpdated(MessageManagedBotUpdated),
...
pub struct MessageCommon {
    /// The tag of the message sender in the chat. TBA 9.5+
    pub sender_tag: Option<String>,
    /// The user an ephemeral message is shown to. TBA 10.2+
    pub receiver_user: Option<User>,
    /// Identifier of the ephemeral message, unique for its receiver. TBA 10.2+
    pub ephemeral_message_id: Option<i64>,
    /// Guest bot that is calling, if any. TBA 10.0+
...
pub enum MediaKind {
    ...
    //
    // See <https://github.com/sinescode/teloxide_max/issues/481>
...
/// Implemented for syntax sugar, see issue <https://github.com/sinescode/teloxide_max/issues/1143>
...
mod tests {
    ...
    /// Regression test for <https://github.com/sinescode/teloxide_max/issues/419>
    #[test]
    fn issue_419() {
        let json = r#"{
            "message_id": 1,
    ...
    /// Regression test for <https://github.com/sinescode/teloxide_max/issues/427>
    #[test]
    fn issue_427() {
    ...
    /// Regression test for <https://github.com/sinescode/teloxide_max/issues/481>
    #[test]
    fn issue_481() {
        let json = r#"
{
...
"#;
    ...
    /// Regression test for <https://github.com/sinescode/teloxide_max/issues/475>
    #[test]
    fn issue_475() {
    ...
    fn topic_created() {
        ...
        let message: Message = serde_json::from_str(json).unwrap();
        // https://github.com/sinescode/teloxide_max/issues/945
        assert!(message.from.is_some());
    }
    ...
    /// Regression test for <https://github.com/sinescode/teloxide_max/issues/873>
    #[test]
    fn empty_message() {
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[cfg_attr(test, derive(schemars::JsonSchema))]
pub struct MessageManagedBotUpdated {
    /// Service message: managed bot updated.
...
pub struct MessagePollOptionAdded {
    ...
    pub poll_option_added: crate::types::PollOptionAdded,
}
...
pub struct MessagePollOptionDeleted {
    ...
    pub poll_option_deleted: crate::types::PollOptionDeleted,
}
