...
///
/// ```rust
/// use teloxide_max_core::types::{File, FileId, FileUniqueId};
/// #
/// # let get_file = || File { meta: teloxide_max_core::types::FileMeta { id: FileId(String::new()), unique_id: FileUniqueId(String::new()), size: 0 }, path: String::new() };
