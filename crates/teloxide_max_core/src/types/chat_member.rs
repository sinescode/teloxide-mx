...
pub struct Member {
    ...
    /// Custom tag for the chat member.
...
pub struct Restricted {
    /// Custom tag set for the chat member. TBA 9.5+
    pub tag: Option<String>,
    /// True, if the user is allowed to edit their own tag. TBA 9.5+
...
///
/// ```no_run
/// use teloxide_max_core::types::ChatMember;
///
