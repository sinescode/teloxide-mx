...
mod tests {
    ...
    // https://github.com/sinescode/teloxide_max/issues/473
    #[tokio::test]
    async fn issue_473() {
        to_form_ref(
    ...
    async fn test_send_media_group() {
        ...
        to_form_ref(&payloads::SendMediaGroup::new(
            ...
            [
                InputMedia::Photo(
                    InputMediaPhoto::new(InputFile::file("../../media/teloxide_max-logo.jpg"))
                        .caption(CAPTION)
                ...
                InputMedia::Animation(
                    ...
                    .thumbnail(InputFile::read(
                        File::open("../../media/teloxide_max-logo.jpg").await.unwrap(),
                    ))
                    .duration(17),
                ),
                InputMedia::Audio(
    ...
    async fn test_send_animation() {
        to_form_ref(
            &payloads::SendAnimation::new(
                ChatId(0),
                InputFile::file("../../media/teloxide_max-logo.jpg"),
            )
            .caption_entities(entities())
            .thumbnail(InputFile::read(
                File::open("../../media/teloxide_max-logo.jpg").await.unwrap(),
